...
public class AVLTree<E extends Comparable<E>> extends Modul_5.BST<E> {
    ...
    @Override
    /**
     * Insert an element and rebalanced if necessary
     */
     ...
     */
    protected static class AVLTreeNode<E> extends Modul_5.BST.TreeNode<E> {
